...
import busImage from "assets/img/member/acando-selvkjorende_buss2.jpg";
import helseImage from "assets/img/member/acando-smart-helse.jpg";

import SectionSolutionTag from "views/MemberPage/Sections/SectionSolutionTag.jsx";

function SectionMemberSolutions({ ...props }) {
  const { classes } = props;
  return (
...
export default withStyles(blogsStyle)(SectionMemberSolutions);
