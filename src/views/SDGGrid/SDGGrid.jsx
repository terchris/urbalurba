    ...
    return (
      <div className={classes.ourClients}>
        <GridContainer justify="center">
          <GridItem md={2} sm={2}>
            <img src="http://bucket.urbalurba.com/sdg/sdg-logo-3.png" alt="no 1" />
          </GridItem>
          <GridItem md={2} sm={2}>
            <img src="http://bucket.urbalurba.com/sdg/sdg-logo-11.png" alt="no 2" />
          </GridItem>
          <GridItem md={2} sm={2}>
            <img src="http://bucket.urbalurba.com/sdg/sdg-logo-17.png" alt="no 3" />
          </GridItem>
        </GridContainer>
      </div>
    );
