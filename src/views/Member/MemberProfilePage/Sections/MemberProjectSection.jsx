...
// App resources
import MemberSolutionTagSection from "./MemberSolutionTagSection.jsx";
import busBeachImage from "assets/member/img/member/acando-fornebu-buss-obos.jpg";

function MemberProjectSection({ ...props }) {
  const { classes } = props;
  return (
...
export default withStyles(blogsStyle)(MemberProjectSection);
